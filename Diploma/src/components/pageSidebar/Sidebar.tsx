...
import search from '../../images/iconsSideBar/search.png'
...
export const Sidebar = (props: InputProps) => {
  const {home, all_films, add_post, favorites_movies} = props;
    return (
       <div className="sidebarPanel">
            ...
            <div className="listSidebar">
                <ul>
                    ...
                    <li><Link className='linkListSidebar' to="/add_post">{add_post}</Link></li>
